...
from ..parser import load_transaction_ast
from ..ast import (
...
def generate_section_from_omt(section_content: str, title: str) -> str:
    """Generate markdown for a section using raw language source."""
...
def generate_actors_from_omt(actors: Dict[str, str]) -> str:
    """Generate markdown for actors using raw language source."""
    if not actors:
        return "No actors defined."
...
def generate_markdown(tx_dir: Path, output_path: Path = None) -> str:
    ...
    # Generate markdown using raw language source
...
class PythonActorGenerator:
    ...
    def _generate_action_code_ast(self, action, indent_level: int, msg_var: str = None) -> List[str]:
        ...
        from ..ast import StoreAction, ComputeAction, LookupAction, SendAction, BroadcastAction, AppendAction, AppendBlockAction
