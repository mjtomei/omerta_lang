...
from omerta_lang.parser import parse
from omerta_lang.ast import expr_to_string
...
class TestParenthesesHandling:
    ...
    def test_unary_with_parentheses(self):
        ...
        """)
        action = schema.actors[0].transitions[0].actions[0]
        from omerta_lang.ast import UnaryExpr, UnaryOperator
